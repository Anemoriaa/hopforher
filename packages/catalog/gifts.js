...
(function () {
  ...
  const gifts = [
    ...
    },
    {
      ...
      vibe: "easy e-reader comfort",
      relationships: ["girlfriend", "wife", "anniversary", "anyone"],
      intents: ["thoughtful", "everyday"],
    ...
    },
    {
      ...
      bestFor: "girlfriend / wife / Kindle or Kobo reader",
      vibe: "bookish everyday carry",
      relationships: ["girlfriend", "wife", "anniversary", "anyone"],
      intents: ["thoughtful", "looks-expensive", "everyday"],
      tabs: ["under-100", "best-overall", "looks-expensive"],
    ...
    },
    {
      ...
      vibe: "small reading upgrade",
      relationships: ["girlfriend", "wife", "new-relationship", "anyone"],
      intents: ["thoughtful", "everyday", "cozy"],
      tabs: ["under-100", "daily-use", "cozy-home"],
    ...
    },
    {
      ...
      vibe: "hands-free cozy reading",
      relationships: ["girlfriend", "wife", "anniversary", "anyone"],
      intents: ["cozy", "everyday", "thoughtful"],
      tabs: ["under-100", "cozy-home", "daily-use"],
    ...
    },
    {
      ...
      hook: "A current romantasy starter with very obvious reader demand.",
      why: "Safer than gifting a later-series sequel because it is book one, instantly recognizable, and already a proven BookTok lane.",
      bestFor: "girlfriend / wife / romantasy reader",
      vibe: "high-energy fantasy read",
      relationships: ["girlfriend", "wife", "anniversary", "new-relationship", "anyone"],
      intents: ["thoughtful", "viral", "everyday"],
      tabs: ["best-overall", "under-100", "daily-use"],
    ...
    },
    {
      ...
      priceLabel: "Kindle price varies",
      badge: "book club hit",
      hook: "A bigger emotional read with very broad current appeal.",
      why: "Strong when you want a standalone title with mainstream proof instead of guessing an obscure niche book.",
      bestFor: "wife / girlfriend / historical fiction reader",
      vibe: "big-feeling conversation starter",
      relationships: ["girlfriend", "wife", "anniversary", "anyone"],
      intents: ["thoughtful", "cozy", "everyday"],
      tabs: ["best-overall", "under-100", "cozy-home"],
    ...
    },
    {
      ...
      why: "Easy to justify because it is a recent Goodreads fiction winner and does not require series knowledge.",
      bestFor: "girlfriend / wife / contemporary fiction reader",
      vibe: "smart beach-read energy",
      relationships: ["girlfriend", "wife", "new-relationship", "anyone"],
      intents: ["thoughtful", "cozy", "viral"],
      tabs: ["best-overall", "under-100", "cozy-home"],
    ...
    },
    {
      ...
      hook: "The older BookTok staple that still converts the fastest.",
      why: "A safer fantasy-romance gift than a deep-cut title because the series is already huge and this starts at book one.",
      bestFor: "girlfriend / wife / fantasy romance reader",
      vibe: "classic booktok starter",
      relationships: ["girlfriend", "wife", "anniversary", "new-relationship", "anyone"],
      intents: ["thoughtful", "viral", "cozy"],
      tabs: ["best-overall", "under-100", "cozy-home"],
    ...
    },
    {
      ...
      hook: "A more substantial physical-book move than gifting one single title.",
      why: "Best when you want a visible present with current romantasy demand and less risk than buying book three by itself.",
      bestFor: "wife / girlfriend / big reader gift",
      vibe: "display-worthy series set",
      relationships: ["girlfriend", "wife", "anniversary", "anyone"],
      intents: ["thoughtful", "looks-expensive", "viral"],
