...
const rawSeoCatalog = [
  ...
  {
    id: "strapsicle-straps",
    slug: "strapsicle-e-reader-hand-straps",
    name: "Strapsicle E-Reader Hand Straps",
    brand: "Strapsicle",
    merchantName: "Strapsicle",
    priceLabel: "$22.99",
    badge: "reader grip",
    hook: "Makes one-handed Kindle reading feel lighter and easier.",
    why: "Useful when she already reads on a Kindle or Kobo and would notice the comfort upgrade immediately without replacing the device.",
    bestFor: "girlfriend / wife / Kindle or Kobo reader",
    query: "Strapsicle hand straps for Kindle Kobo gift",
    sourceProductUrl: "https://www.strapsicle.com/en-us/products/neon-range-straps-set-of-two",
  },
  {
    id: "strapsicle-clutch",
    slug: "strapsicle-clutch-e-reader-cover",
    name: "Strapsicle Clutch E-Reader Cover",
    brand: "Strapsicle",
    merchantName: "Strapsicle",
    priceLabel: "$24.99",
    badge: "reader carry",
    hook: "A cleaner way to stash an e-reader without making it feel like office gear.",
    why: "Stronger than a generic pouch when the gift should feel reader-specific, useful, and a little more finished.",
    bestFor: "girlfriend / wife / Kindle or Kobo reader",
    query: "Strapsicle clutch e-reader cover gift",
    sourceProductUrl: "https://www.strapsicle.com/en-us/products/strapsicle-clutch",
  },
  {
    id: "glocusent-book-light",
    slug: "glocusent-bookmark-style-reading-light",
    name: "Glocusent Bookmark Style Reading Light",
    brand: "Glocusent",
    merchantName: "Glocusent",
    priceLabel: "$18.99",
    badge: "reader essential",
    hook: "Small, giftable, and actually useful for late-night reading.",
    why: "Better than a generic lamp add-on when you want one reading-specific accessory she can use the same night.",
    bestFor: "girlfriend / wife / bedtime reader",
    query: "Glocusent bookmark style reading light gift",
    sourceProductUrl: "https://glocusent.com/products/glocusent-bookmark-style-best-reading-light",
  },
  {
    id: "glocusent-neck-light",
    slug: "glocusent-led-neck-reading-light",
    name: "Glocusent LED Neck Reading Light",
    brand: "Glocusent",
    merchantName: "Glocusent",
    priceLabel: "$25.49",
    badge: "cozy reader",
    hook: "A softer hands-free upgrade for reading in bed or on the couch.",
    why: "Works when she already reads at night and would use a more comfortable personal light more than another decor item.",
    bestFor: "girlfriend / wife / night reader",
    query: "Glocusent neck reading light gift",
    sourceProductUrl: "https://glocusent.com/products/glocusent-ergonomic-led-neck-light",
  },
  {
...
export const seoGuides = [
  ...
  },
  {
    ...
    description: "Kindle gifts for her, built around one stronger device upgrade, two cleaner Kindle add-ons, and exact Kindle editions that already have demand.",
    intro: "Use this lane when the ebook setup is the reason the gift makes sense and you want Kindle-specific utility, not a generic broader books page.",
    selectionMethod: "This page mixes the core Kindle hardware lane with exact Kindle editions and two smaller Kindle-specific support pieces, so the gift can solve either the device problem or the day-to-day reading-friction problem.",
    bestUseCase: "Use this when she already reads digitally, sends Kindle screenshots, or would get more value from easier e-reader use than from a random physical add-on.",
    avoidWhen: "Skip this page if the point is giving a visible physical stack, a collector-style book gift, or a softer general cozy-home present instead of a Kindle-specific answer.",
    buyerSignals: [
      {
        title: "Kindle gifts work best when the reading habit is already digital",
        body: "If she already reads on a Kindle or Kindle app, the safest moves here are a stronger e-reader setup upgrade or an exact Kindle title she can open immediately.",
      },
      {
        title: "There are really two good Kindle gift lanes",
        body: "Either improve how she reads on the device itself or buy the next Kindle title. This page is strongest when you stay inside one of those lanes instead of drifting into general reader decor.",
      },
      {
        title: "First-in-series and broad standalones still beat sequel guesses",
        body: "When you do buy the book itself, stick to book one or an easy standalone so the digital gift still feels considered instead of risky.",
      },
    ],
    faqs: [
      {
        q: "What is the safest Kindle gift on this page?",
        a: "Kindle Paperwhite Signature Edition is the safest full Kindle gift when you want a real upgrade. Strapsicle E-Reader Hand Straps is the safer lower-cost answer when she already has the device and just needs reading to feel easier.",
      },
      {
        q: "Do I need to buy the device for a Kindle gift to work?",
        a: "No. If she already reads digitally, the title alone is enough. Buy the device only when the real pain point is the setup itself, not the next book.",
      },
      {
        q: "When should I use the broader books guide instead?",
        a: "Use the broader books page when you want to compare Kindle picks with a visible physical set. Stay here when the Kindle-specific angle is the whole point.",
      },
    ],
    bestFits: [
      {
        title: "The clearest Kindle device upgrade",
        giftId: "kindle-paperwhite",
        body: "Best when the main gift should improve how she reads every night, not just what she reads next.",
      },
      {
        title: "The easiest Kindle comfort add-on",
        giftId: "strapsicle-straps",
        body: "Use this when she already owns the device and would notice the one-handed reading upgrade immediately.",
      },
      {
        title: "The clearest current Kindle title",
        giftId: "fourth-wing-kindle",
    ...
    avoidNotes: [
      {
        title: "Avoid mixing too many Kindle lanes into one gift",
        body: "Choose either the device upgrade, one small Kindle comfort add-on, or the exact title. Piling on extras usually feels less intentional than one cleaner answer.",
      },
      {
        title: "Avoid sequel guesses if the title is doing the work",
        body: "If you cannot tell what she has already read, first-in-series books and standalones are still the safer Kindle move.",
      },
    ],
    pickLanes: [
      {
        title: "Best Kindle hardware gift",
        giftId: "kindle-paperwhite",
        body: "The first answer when the setup itself needs to feel more premium and easier to use.",
      },
      {
        title: "Best small Kindle add-on",
        giftId: "strapsicle-straps",
        body: "Use this when you want a lower-cost Kindle-specific gift that still feels obviously reader-first.",
      },
      {
    ...
    itemIds: ["strapsicle-straps", "strapsicle-clutch", "kindle-paperwhite", "fourth-wing-kindle", "acotar-kindle"],
    related: ["books-for-her", "booktok-gifts-for-her", "cozy-gifts-for-readers"],
  },
  {
    ...
    description: "Cozy gifts for readers, built around softer fiction and two low-friction reading-light upgrades instead of a general reader-gadget pile.",
    intro: "Use this page when reading is part of how she winds down and the gift should make that nightly routine feel softer, easier, and more handled.",
    selectionMethod: "This page mixes two approachable Kindle fiction picks with two dedicated reading lights and one cozy branded comfort piece, so the gift supports the whole unwind ritual instead of just adding another title.",
    bestUseCase: "Use this when she likes slow weekends, bedtime reading, book-club fiction, or couch-reading routines more than trendier gift lanes.",
    avoidWhen: "Skip this page if you need a visibly collectible stack, a broad books-only page, or a non-reading lifestyle gift that wins on fashion or beauty instead.",
    buyerSignals: [
      {
        title: "The strongest cozy-reader gifts reduce friction",
        body: "This lane performs best when the gift makes bedtime or couch reading easier with better light, softer comfort, or a gentler book choice she can settle into fast.",
      },
      {
        title: "Mood matters more than maximal setup",
        body: "One good reading light and one softer fiction pick usually land better here than piling on random accessories that only sound bookish.",
      },
      {
        title: "Softer fiction usually beats huge fantasy worlds here",
        body: "If her taste leans emotional, warm, or book-club adjacent, broader fiction and comfort upgrades usually land better than a more intense trend-heavy series.",
      },
    ],
    faqs: [
      {
        q: "What is the safest cozy reader gift on this page?",
        a: "Glocusent LED Neck Reading Light is the safest all-around comfort upgrade because it improves the reading routine immediately. The Wedding People Kindle Edition is the safer book-only answer when you still want the gift to stay on a title.",
      },
      {
        q: "Should I buy a reading light or one strong read?",
        a: "Choose the light when she already has books waiting and the comfort problem is the real issue. Choose the book when she always wants the next good read and the setup already works.",
      },
      {
        q: "When should I leave this page for the broader books guide?",
        a: "Leave for the broader books guide when you want a wider mix of Kindle editions, BookTok titles, and visible physical-book options. Stay here when the softer unwind angle is the reason the gift will land.",
      },
    ],
    bestFits: [
      {
        title: "The easiest hands-free reading upgrade",
        giftId: "glocusent-neck-light",
        body: "Best when she already reads in bed or on the couch and would notice the comfort change immediately.",
      },
      {
        title: "The smaller reading-light gift",
        giftId: "glocusent-book-light",
        body: "Use this when you want the cheapest clean reader-specific upgrade that still feels intentional.",
      },
      {
        title: "The safest comfort-read Kindle pick",
        giftId: "the-wedding-people-kindle",
        body: "This is the cleaner book-only answer when you want an approachable fiction pick with strong proof and almost no genre explanation.",
      },
    ],
    avoidNotes: [
      {
        title: "Avoid turning this page into generic dorm-room clutter",
        body: "The gift should still improve reading specifically, not just add random soft goods or decor that happen to sit near books.",
      },
      {
        title: "Avoid forcing high-hype fantasy when softer fiction is the real signal",
        body: "If her taste leans literary or book-club, broader fiction and comfort upgrades usually land better than choosing a huge fantasy world by default.",
      },
    ],
    pickLanes: [
      {
        title: "Best bedtime-reading upgrade",
        giftId: "glocusent-neck-light",
        body: "The first answer when you want the nightly reading routine to feel easier and more comfortable fast.",
      },
      {
        title: "Best soft fiction pick",
        giftId: "the-wedding-people-kindle",
        body: "Use this when you want a lighter, easier fiction lane without a huge genre commitment.",
      },
      {
        title: "Best coziest branded comfort add-on",
        giftId: "ugg-slippers",
        body: "The better move when she already has enough books but the reading-at-home mood still needs a warmer gift.",
      },
    ],
    itemIds: ["glocusent-book-light", "glocusent-neck-light", "the-wedding-people-kindle", "the-women-kindle", "ugg-slippers"],
    related: ["books-for-her", "kindle-gifts-for-her", "gifts-for-homebodies"],
  },
  {
    ...
    description: "Book-lover gifts for her, built around one visible book set, one e-reader carry upgrade, and a few stronger reading-life upgrades.",
    intro: "Use this lane when reading is part of her identity and you want the gift to feel unmistakably bookish without pretending every answer has to be one more title.",
    selectionMethod: "This page balances one visible boxed set, one Kindle-specific carry piece, one device upgrade, and two reading-life picks so the gift can match either the identity signal or the daily routine signal.",
    bestUseCase: "Use this when she talks about books, reading goals, Kindle habits, or book stacks and you want the gift to reinforce that identity in a way she will keep using.",
    avoidWhen: "Skip this page if the reading angle is minor or if you already know the exact book she wants and should just buy that book directly instead.",
    buyerSignals: [
      {
        title: "Book-lover gifts do not all need to be one more book",
        body: "This lane works when the gift still feels reader-specific but solves something around how she carries, reads, or keeps up the habit.",
      },
      {
        title: "Visible stack gifts and daily-use reading upgrades solve different versions of the same signal",
        body: "The series set wins when the unwrap matters. Device or carry upgrades win when she already has the books and would use the support item more often.",
      },
      {
        title: "You still do not need perfect genre knowledge",
        body: "If you know reading matters but not her exact backlist, the safer move is a visible set or a reader-specific upgrade rather than guessing a niche title.",
      },
    ],
    faqs: [
      {
        q: "What is the safest book-lover gift on this page?",
        a: "The Empyrean box set is the safest visible book-lover gift because it gives her an actual stack to open. Kindle Paperwhite Signature Edition is the safer daily-use upgrade when she already reads digitally.",
      },
      {
        q: "Do reader upgrades still count as book-lover gifts?",
        a: "Yes, if they clearly improve the reading habit itself. A Kindle device upgrade or an e-reader carry piece can land better than guessing one more title she may already own.",
      },
      {
        q: "When should I leave this page for Kindle gifts instead?",
        a: "Leave for Kindle gifts when the ebook setup is the whole point. Stay here when you want the broader book-lover identity and want to compare visible book gifts with reading-life upgrades.",
      },
    ],
    bestFits: [
      {
      ...
      {
        title: "The clearest Kindle-reader upgrade",
        giftId: "kindle-paperwhite",
        body: "Use this when she already reads digitally and the gift should improve the habit every day instead of adding one more title.",
      },
      {
        title: "The strongest bookish carry add-on",
        giftId: "strapsicle-clutch",
        body: "This is the better answer when she already owns an e-reader and you want a smaller reader-specific gift that still looks handled.",
      },
    ],
    avoidNotes: [
      {
        title: "Avoid random bookish merchandise with no reading function",
        body: "If the product would feel just as at home in a generic decor store, it is probably too weak for the book-lover lane.",
      },
      {
        title: "Avoid guessing a hyper-specific niche title just to sound well read",
        body: "If the exact taste match is shaky, stay with the set or a reader-specific upgrade instead of reaching for something obscure.",
      },
    ],
    pickLanes: [
      {
      ...
      {
        title: "Best daily reading upgrade",
        giftId: "kindle-paperwhite",
        body: "Use this when she already reads enough that the device itself is the smarter upgrade than one more title.",
      },
      {
        title: "Best smaller bookish carry gift",
        giftId: "strapsicle-clutch",
        body: "The stronger move when you want something reader-specific, useful, and easier to hand over than a bigger device.",
      },
    ],
    itemIds: ["strapsicle-clutch", "empyrean-box-set", "kindle-paperwhite", "glocusent-book-light", "cashmere-robe"],
    related: ["books-for-her", "booktok-gifts-for-her", "gifts-for-homebodies"],
  },
  {
