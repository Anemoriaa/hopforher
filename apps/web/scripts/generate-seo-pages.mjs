  ...
  return [
    {
      ...
      a: productKindAnswer(gift),
    },
    {
      q: `When should I choose ${gift.name}?`,
      a: productWhenAnswer(gift, leadGuide),
    },
    {
  ...
  const guideRail = renderPageRail([
    {
      ...
      cta: featuredGift
        ...
        ${renderUserFacingGiftLink(featuredGift, giftDetailLinkLabel(featuredGift, "Open top pick"), "discovery-text-link")}
...
function renderProductPage(gift, freshness = lastmodPlaceholder) {
  ...
  const description = productMetaDescription(gift);
